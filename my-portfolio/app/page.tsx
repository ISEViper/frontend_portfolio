...
import { SiTypescript, SiNextdotjs, SiVuedotjs, SiTailwindcss, SiBootstrap, SiFlutter, SiDjango, SiVite, SiWebpack, SiThreedotjs, SiJira } from 'react-icons/si';
...
export default function Home() {
  ...
  return (
    <div className="app-wrapper">
      ...
      <footer id="contact">
        <h2 className="footer-title">Conversing through code</h2>
        <h2 className="footer-title outline" style={{ fontStyle: 'italic' }}>with users beyond the screen</h2>
      </footer>
