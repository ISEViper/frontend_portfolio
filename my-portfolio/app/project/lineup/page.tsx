        ...
        <div className="detail-body">
          ...
          <div className="detail-main detail-fade-up">
            ...
            >
              ...
              <div className="demo-container-responsive">
                ...
                {previewMode === 'app' ? (
                  <div className="demo-mobile-frame">
                    <div className="demo-header" style={{ backgroundColor: '#ff4757' }}>Booth App</div>
                    <div className="demo-content" style={{ justifyContent: 'flex-start', padding: '20px' }}>
                      <div className="demo-ticket">
                        <span>My Queue Number</span>
                        <h2>142</h2>
                        <p>Waiting... (Approx 15m)</p>
                      </div>
                    </div>
                  </div>
                ) : (
                  <div className="demo-web-frame">
                    <div className="demo-header" style={{ backgroundColor: '#2f3542' }}>Admin Dashboard</div>
                    <div className="demo-web-content">
                      <div className="web-sidebar"></div>
                      <div className="web-main">
                        <div className="web-card-row">
                          <div className="web-card">Total: 450</div>
                          <div className="web-card">Waiting: 38</div>
                        </div>
                        <div className="web-chart-sim">Real-time Traffic Syncing...</div>
                      </div>
                    </div>
                  </div>
                )}
