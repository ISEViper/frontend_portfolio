          ...
          <div className="detail-main detail-fade-up">
            ...
            >
              ...
              <div className="demo-mobile-frame">
                <div className="demo-header">3DGS Viewer</div>
                <div className="demo-content">
                  {!demoActive ? (
                    <button className="demo-btn" onClick={() => setDemoActive(true)}>Render Model</button>
                  ) : (
                    <div className="demo-model-sim">
                      <div className="model-cube"></div>
                      <p className="model-text">3D Data Loaded</p>
                    </div>
                  )}
                </div>
              </div>
